/*Try with a singe queue to output ping packets
if packet_id functions properly, the ping should not be dropped
Try with given id first, then with 1*/
